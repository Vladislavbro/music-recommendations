"""Unit-тесты для `src/aggregators/{base,agree}.py` (Phase 2, шаг 7).

Запуск:
    python tests/test_aggregators.py            # standalone runner
    pytest tests/test_aggregators.py -q          # pytest-совместимо
"""
