"""Unit-тесты для `research/grouprec/training/{bpr_loss, group_trainer}.py` (Phase 2, шаг 6).

Запуск:
    pytest research/tests/test_training.py -q
"""
...
from grouprec.training.bpr_loss import pairwise_bpr_loss
...
def test_trainer_predict_scores_match_eval_shape():
    ...
    try:
        ...
        for s, sc in zip(setup["val_samples"], scores, strict=True):
